...
searchbox.clear()
searchbox.send_keys('@mhmmd.haidar_05')
time.sleep(5)
...
#posts
posts = ['https://www.instagram.com/p/COwvH8FAVPx/','https://www.instagram.com/p/CMtoelrgj5V/',
		 'https://www.instagram.com/p/CLEdqWAgDJT/']
